...
var canSetProperty = exports.canSetProperty = function (object, key) {
        ...
        for (var key in values) {
            ...
            if (deleteNull && value === deleteValue && !Array.isArray(target)) {
                delete target[key];
            } else {
        ...
        return {
            merge: function () {
                ...
                if (!equal([
                    ...
                    throw new Error('Assertion Failed: (equal([1, null], merge([1,2], {1:null})))');
                if (!equal([
                        1,
                        void 0
                    ], merge([
            ...
            observe: function (done) {
                ...
                {
                    source.name = 'Fred';
                    source.children = ion.patch.combine(source.children, {
                        Orion: {
                            a: 1,
                            b: 2,
                            c: 12
