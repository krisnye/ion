...
export type Identifier_Identifier_or_ion_types_Pattern_Pattern_or_ion_Null_Null = Identifier.Identifier | (Pattern.Pattern | Null.Null);
export type Expression_Expression_or_ion_types_Identifier_Identifier_or_ion_types_Pattern_Pattern_or_ion_Null_Null = Expression.Expression | (Identifier.Identifier | (Pattern.Pattern | Null.Null));
