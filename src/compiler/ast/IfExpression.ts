...
export class IfExpression implements _Object.Object , Expression.Expression , Typed.Typed , Node.Node {
    ...
    static readonly id = 'IfExpression';
    ...
    static is(value): value is IfExpression {
        return isIfExpression(value);
    }
}
export function isIfExpression(value): value is IfExpression {
    return Class.isInstance(IfExpression, value);
}
