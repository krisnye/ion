...
// import { BinaryExpression, Reference, Identifier, MemberExpression, UnaryExpression, Call, Property, Literal, Expression, ExpressionStatement } from "../../ast"
...
// //  only ported up to here!!!!!!!! over to newTypeAnalysis.test.ts
