  ...
  var result = {
    ...
    parse : function _parse(input, startRule) {
      ...
      function parse_definition() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, a, b) { return e("=", [a,b]) })(pos0, result0[1], result0[5]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_newScopeStatements() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, a, b) { return a.concat(b) })(pos0, result0[1], result0[2]);
        }
        if (result0 === null) {
          pos = pos0;
        }
