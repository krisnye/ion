(function(){require.register('ion/parser',function(module,exports,require){module.exports = (function(){
  /*
  ...
  var result = {
     ...
     */
    parse : function _parse(input, startRule) {
      var parseFunctions = {
        "statement": parse_statement,
        "definition": parse_definition,
        "setAndDefinition": parse_setAndDefinition,
        "if": parse_if,
        "else": parse_else,
        "for": parse_for,
        "add": parse_add,
        ...
        "step": parse_step,
        "steps": parse_steps,
        "localExpression": parse_localExpression,
        ...
        "ref": parse_ref,
        "outputRef": parse_outputRef,
        "inputRef": parse_inputRef,
        "idRef": parse_idRef,
        "id": parse_id,
        "key": parse_key,
        "literal": parse_literal,
        "literalObject": parse_literalObject,
            ...
            if (result1 === null) {
              ...
              if (result1 === null) {
                ...
                if (result1 === null) {
                  ...
                  if (result1 === null) {
                    result1 = parse_setAndDefinition();
                  }
                }
              }
            }
      ...
      function parse_definition() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, id, a) { return e("var", [id,a]) })(pos0, result0[2], result0[6]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_setAndDefinition() {
        var cacheKey = "setAndDefinition@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_lineExpression() {
        var cacheKey = "lineExpression@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_singleLineExpression() {
        var cacheKey = "singleLineExpression@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_multiLineExpression() {
        var cacheKey = "multiLineExpression@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_multilineObject() {
        var cacheKey = "multilineObject@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_multilineString() {
        var cacheKey = "multilineString@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_multilineStringLine() {
        var cacheKey = "multilineStringLine@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_multilineStringContent() {
        var cacheKey = "multilineStringContent@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_path() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, a, b) { return joinLeft([a].concat(b)) })(pos0, result0[0], result0[1]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_steps() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, a) { return joinLeft(a); })(pos0, result0);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_localExpression() {
        var cacheKey = "localExpression@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        if (result0 !== null) {
          result0 = (function(offset, a) { return e("local", [a]) })(pos0, result0[1]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_propertyIndexer() {
        var cacheKey = "propertyIndexer@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_list() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, a, b) { b.unshift(a); return b })(pos0, result0[0], result0[1]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_object() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, type, statements) { return e("object", [type,statements]) })(pos0, result0[0], result0[3]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_ref() {
        ...
        result0 = parse_inputRef();
        if (result0 === null) {
          result0 = parse_outputRef();
          if (result0 === null) {
            result0 = parse_idRef();
          }
        }
      ...
      function parse_outputRef() {
        var cacheKey = "outputRef@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        if (result0 !== null) {
          result0 = (function(offset, a) { return e("output", [a.length - 1]) })(pos0, result0);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_inputRef() {
        var cacheKey = "inputRef@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        if (result0 !== null) {
          result0 = (function(offset) { return e("input") })(pos0);
        }
        if (result0 === null) {
          pos = pos0;
        }
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, a) { return e("input", [a.length - 1]) })(pos0, result0);
          }
          if (result0 === null) {
            pos = pos0;
          }
      ...
      function parse_idRef() {
        ...
        result0 = parse_id();
        if (result0 !== null) {
          result0 = (function(offset, a) { return e("ref", [a]) /* we postprocess to determine if this is a variable or global reference */ })(pos0, result0);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_literalObject() {
        var cacheKey = "literalObject@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        if (result0 !== null) {
          result0 = (function(offset) { return e("object", [null]) })(pos0);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_literalArray() {
        ...
        if (result0 !== null) {
          result0 = (function(offset) { return e("object", [arrayType()]) })(pos0);
        }
        if (result0 === null) {
          pos = pos0;
        }
    ...
    toSource : function _toSource() { return this._source; }
  };
  
  /* Thrown when a parser encounters a syntax error. */
  
  result.SyntaxError = function _SyntaxError(expected, found, offset, line, column) {
