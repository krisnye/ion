...
(function() {
  ...
  module.exports = IfStatement = (function(_super) {
    ...
    IfStatement.prototype.activate = function _activate() {
      ...
      return this.conditionExpression.watch(this.conditionWatcher != null ? this.conditionWatcher : this.conditionWatcher = function _conditionWatcher(conditionValue) {
    ...
    IfStatement.prototype._choose = function __choose() {
      var _ref1, _ref2;
