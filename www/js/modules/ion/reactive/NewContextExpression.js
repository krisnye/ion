(function(){require.register('ion/reactive/NewContextExpression',function(module,exports,require){// Generated by CoffeeScript 1.6.3
(function() {
  ...
  module.exports = NewContextExpression = (function(_super) {
    ...
    NewContextExpression.prototype.activate = function _activate() {
      var _this = this;
      NewContextExpression.__super__.activate.call(this);
      return this.leftExpression.watch(this.leftWatcher != null ? this.leftWatcher : this.leftWatcher = function _leftWatcher(value) {
        var _ref;
        if (_this.leftValue !== value) {
          ...
          if (_this.leftValue != null) {
            if (_this.operation.observeLeftValue) {
              if (_this.leftObserver == null) {
                _this.leftObserver = function _leftObserver(changes) {
                  return _this.evaluate();
                };
              }
              core.observe(_this.leftValue, _this.leftObserver);
            }
            _this.leftContext = new Context(_this.leftValue, _this.context);
            if (_this.rightWatcher == null) {
              _this.rightWatcher = function _rightWatcher(value) {
    ...
    NewContextExpression.prototype.deactivate = function _deactivate() {
      NewContextExpression.__super__.deactivate.call(this);
      return this.leftExpression.unwatch(this.leftWatcher);
    };

    NewContextExpression.prototype.evaluate = function _evaluate() {
      var value;
