(function(){require.register('ion/reactive/BlockStatement',function(module,exports,require){// Generated by CoffeeScript 1.6.3
(function() {
  ...
  module.exports = BlockStatement = (function(_super) {
    ...
    BlockStatement.prototype.activate = function _activate() {
      var statement, _i, _len, _ref1, _results;
      BlockStatement.__super__.activate.call(this);
      if (this.statements == null) {
        this.statements = Operation.getRuntimes(this.context, this.args);
      }
    ...
    BlockStatement.prototype.deactivate = function _deactivate() {
      var statement, _i, _len, _ref1, _results;
