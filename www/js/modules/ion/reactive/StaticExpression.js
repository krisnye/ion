(function(){require.register('ion/reactive/StaticExpression',function(module,exports,require){// Generated by CoffeeScript 1.6.3
(function() {
  ...
  module.exports = StaticExpression = (function(_super) {
    ...
    StaticExpression.prototype.getValue = function _getValue() {
      return this.value;
    };

    StaticExpression.prototype.watch = function _watch(watcher) {
      return watcher(this.value);
    };

    StaticExpression.prototype.unwatch = function _unwatch(watcher) {
